...
const AboutPage = (props: Props) => {
	return (
		<main className="font-heebo overscroll-y-none z-1 overflow-x-hidden overflow-y-auto" dir="rtl">
			<DotPattern
				className={cn(
				...
				<NeonGradientCard className="max-w-2xl z-10">
					...
					<div>
						<p className="mb-6 text-lg text-foreground text-pretty">
							...
							<strong>NextUI</strong> לרכיבי UI מותאמים ונגישים
							וב-<strong>Tailwind CSS</strong> לעיצוב רספונסיבי
							ומודרני. האפליקציה מתבססת על{" "}
							<strong>Zustand</strong> לניהול states בצורה פשוטה,
							וכן <strong>Leaflet</strong> להצגת מפות
							...
							של נתונים בזמן אמת וארכיטקטורה גמישה ופשוטה לתחזוקה.
						</p>
